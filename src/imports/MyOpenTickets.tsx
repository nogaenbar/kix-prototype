import svgPaths from "./svg-b99b8ujj5u";
  ...
  return (
    <div className="basis-0 grow h-[20px] min-h-px min-w-px relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-full">
        <p className="absolute font-['Inter:Regular',_sans-serif] font-normal leading-[20px] left-0 not-italic text-[#6a7282] text-[14px] text-nowrap top-0 whitespace-pre">12 tickets</p>
      </div>
    </div>
  );
}
...
export default function MyOpenTickets() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start overflow-clip relative rounded-[12px] size-full" data-name="My open tickets">
      <CardHeader />
      <CardContent1 />
    </div>
  );
