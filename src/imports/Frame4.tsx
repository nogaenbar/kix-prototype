import svgPaths from "./svg-92q990hm2a";
  ...
  return (
    <div className="relative size-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] items-start pl-0 pr-[12px] py-[12px] relative size-full">
          <KixTopBar />
        </div>
      </div>
    </div>
