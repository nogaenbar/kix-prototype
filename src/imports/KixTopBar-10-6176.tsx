import svgPaths from "./svg-wynab4abxd";
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d="M14 14L11.1066 11.1067" id="Vector" stroke="var(--stroke-0, #525252)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
    ...
    <div className="basis-0 grow h-[24px] min-h-px min-w-px relative shrink-0" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex h-[24px] items-center px-[16px] py-0 relative w-full">
          <p className="font-['Inter:Regular',_sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-center text-neutral-500 text-nowrap whitespace-pre">Search tickets, contacts…</p>
        </div>
      </div>
    </div>
  );
...
function KixSearchExpandable() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[10px] items-center px-[16px] py-[8px] relative rounded-[3.35544e+07px] shrink-0 w-[360px]" data-name="KIXSearchExpandable">
...
function Button() {
  return (
    <div className="content-stretch flex items-center justify-center relative rounded-[12px] shrink-0 size-[36px]" data-name="Button">
      <Icon1 />
    </div>
  );
}
...
function Icon3() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_10_6106)" id="Icon">
  ...
  return (
    <div className="h-[73px] relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center justify-end relative size-full">
        <div className="box-border content-stretch flex gap-[16px] h-[73px] items-center justify-end px-[16px] py-0 relative w-full">
          <Container />
        </div>
      </div>
    </div>
...
export default function KixTopBar() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col items-start justify-center pb-px pt-0 px-0 relative size-full" data-name="KIXTopBar">
      <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-slate-300 border-solid inset-0 pointer-events-none shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)]" />
      <Container1 />
    </div>
  );
}