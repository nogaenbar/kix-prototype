import svgPaths from "./svg-dngfd6z2qn";
...
function Container() {
  return (
    <div className="content-stretch flex h-[36px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="basis-0 font-['Inter:Semi_Bold',_sans-serif] font-semibold grow leading-[36px] min-h-px min-w-px not-italic relative shrink-0 text-[30px] text-white tracking-[-0.75px]">856</p>
    </div>
  );
}
...
function KpiTile1() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-[334px]" data-name="KPITile">
...
export default function Card() {
  return (
    <div className="relative rounded-[16.4px] size-full" data-name="Card">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col items-start overflow-clip pl-[25px] pr-px py-[25px] relative size-full">
          <KpiTile1 />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-slate-300 border-solid inset-0 pointer-events-none rounded-[16.4px]" />
    </div>
  );
}